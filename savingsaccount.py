...
class SavingsAccount:
    ...
    def __eq__(self, other):
        """Returns whether this account name is alphabetically equal to other"""
        return self.getName() == other.getName()

    def __lt__(self, other):
        """Returns whether this account name is alphabetically first than other"""
        return self.getName() < other.getName()
    
    def __ge__(self, other):
        """Returns whether this account name is alphabetically greater than or equal to other"""
        return self.getName() >= other.getName()
